...
const categories = [
  {
    key: 'gear',
    label: 'Gear',
    subcategories: ['Harnesses', 'Ropes', 'Helmets', 'Crash pads'],
    defaultBg: '#6a8a94',
    href: '/listings?category=Gear',
  },
  {
    key: 'shoes',
    label: 'Shoes',
    subcategories: ['Climbing shoes', 'Approach shoes', 'Mountain boots'],
    defaultBg: '#8a6a54',
    href: '/listings?category=Shoes',
  },
  {
    key: 'clothing',
    label: 'Clothing',
    subcategories: ['Jackets', 'Hoodies', 'Pants', 'T-Shirts'],
    defaultBg: '#6a7a5a',
    href: '/listings?category=Clothing',
  },
  {
    key: 'wall',
    label: 'Wall equipment',
    subcategories: ['Climbing holds', 'Safety mats', 'Wall materials'],
    defaultBg: '#7a8a9a',
    href: '/listings?category=Wall+equipment',
  },
]
          ...
          {categories.map(cat => (
            <a key={cat.key} href={cat.href} className="home-cat-card">
              <div
                ...
                style={{ background: cat.defaultBg }}
